declare namespace API {
  ...
  type BaseResponsePageQuestionView_ = {
    code?: number;
    data?: PageQuestionView_;
    message?: string;
  };

  type BaseResponsePageQuestionViewVO_ = {
    code?: number;
    data?: PageQuestionViewVO_;
    message?: string;
  };
  ...
  type BaseResponseQuestionViewVO_ = {
    code?: number;
    data?: QuestionViewVO;
    message?: string;
  };
  ...
  type getQuestionViewVOByIdUsingGETParams = {
    /** id */
    id?: number;
  };
  ...
  type PageQuestionView_ = {
    ...
    orders?: OrderItem[];
    pages?: number;
    records?: QuestionView[];
    searchCount?: boolean;
    size?: number;
    total?: number;
  };

  type PageQuestionViewVO_ = {
    countId?: string;
    current?: number;
    maxLimit?: number;
    optimizeCountSql?: boolean;
  ...
  type QuestionViewUpdateRequest = {
    questionId?: number;
    userId?: number;
    viewId?: number;
  };
